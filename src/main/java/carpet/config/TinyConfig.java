...
public class TinyConfig {
    ...
    private static final Logger LOGGER = LogManager.getLogger("chatup");

    private static final String MOD_NAME = "[Chat-Up!]";
    ...
    public static void init(String modid, Class<?> config) {
        ...
        try {
            ...
            LOGGER.error(MOD_NAME + ": Couldn't load config; reverting to defaults");
            write();
        }
    ...
    public static void write() {
        try {
            ...
            LOGGER.error(MOD_NAME + ": Couldn't save config.");
            e.printStackTrace();
        }
        ...
        protected void init() {
            ...
            for (EntryInfo info : entries) {
                if (info.widget instanceof Map.Entry) {
                    ...
                    TextFieldWidget widget = addDrawable(new TextFieldWidget(textRenderer, width-85, y, info.width, 20, null));
